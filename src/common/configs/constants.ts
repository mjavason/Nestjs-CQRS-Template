...
export const PAYSTACK_LIVE_SECRET_KEY =
  process.env.PAYSTACK_LIVE_SECRET_KEY || 'xxxx';
export const PAYSTACK_LIVE_PUBLIC_KEY =
  process.env.PAYSTACK_LIVE_PUBLIC_KEY || 'xxxx';
export const PAYSTACK_TEST_SECRET_KEY =
  process.env.PAYSTACK_TEST_SECRET_KEY || 'xxxx';
